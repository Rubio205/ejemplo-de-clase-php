...
# Instalar dos2unix para convertir finales de línea **
RUN apt-get update && apt-get install -y dos2unix

# Copia el código fuente
COPY . .

# Corregir archivos comunes con terminaciones de línea CRLF **
RUN dos2unix artisan phpunit composer.json composer.lock 2>/dev/null || true
